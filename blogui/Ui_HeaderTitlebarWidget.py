...
class Ui_HeaderTitlebarWidget(object):
    def setupUi(self, HeaderTitlebarWidget):
        ...
        self.pb_Skin.setStyleSheet("border:none;")
        ...
        self.pb_Minimum.setStyleSheet("border:none;")
        ...
        self.pb_Maximum.setStyleSheet("border:none;")
        ...
        self.pb_Normal.setStyleSheet("border:none;")
        ...
        self.pb_Close.setStyleSheet("border:none;")
